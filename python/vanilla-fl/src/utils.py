...
def sample_noniid_new(num_clients: int, 
    ...
    transform = transforms.Compose([
        ...
        transforms.ToTensor()])
    mnist_dataset = MNIST(root='./data', train=train, download=download, transform=transform)
...
dict_users = sample_noniid_new(num_clients, num_shards, num_imgs, shards_per_client)
